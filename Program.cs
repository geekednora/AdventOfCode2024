...
internal static class Program
{
    static void Main()
    {
        ...
        var solution = new AdventOfCode2024.Day7.Solution();
        
        /* First Solution */
        sw1.Start();
        
        Console.Write("Solution 1: " + solution.Solve1(@"Z:\source\AdventOfCode2024\Day7\input.txt")
        ...
        Console.Write("Solution 2: " + solution.Solve2(@"Z:\source\AdventOfCode2024\Day7\input.txt")
            , Console.ForegroundColor = ConsoleColor.DarkGreen); Console.ResetColor();
